...
export const HOOPS_TEXT = {
  ...
  /* ADR-038: the make/miss reads — never squint at the chain again */
  inMake: 'IN!',
  deepMake: 'FROM DEEP!',
  noGood: 'NO GOOD.',
  airPopup: 'AIR.',
  ...
  tutDunk: 'LESSON 3: RUN AT THE RIM AND PRESS A — THEN KEEP HOLDING AND RELEASE A IN THE FINISH METER. LAYUPS FORGIVE. DUNKS DO NOT.',
