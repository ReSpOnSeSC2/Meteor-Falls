...
export const DEALERSHIP: Record<string, CarForSale> = Object.fromEntries(
  [
    ...
    C({ id: 'kids_bmx', vehicleType: 'bmx', band: 'ch1', price: 90, title: 'title_car_bmx',
      dealer: 'Bert', note: '"My nephew outgrew it. Pegs included. Smells like a garage and a thousand summers."' }),
    C({ id: 'ten_speed', vehicleType: 'road_bike', band: 'ch1', price: 240, title: 'title_car_road_bike',
      dealer: 'Bert', note: '"Light as a rumor. Whoever owned her last waxed the chain. I respect that. I do not understand it."' }),
    C({ id: 'old_reliable', vehicleType: 'motorcycle', band: 'ch1', price: 2600, title: 'title_car_motorcycle',
      dealer: 'Bert', note: '"One careful owner who is now afraid of it. Starts every time. Stops most times."' }),
    C({ id: 'commuter', vehicleType: 'sedan', band: 'ch1', price: 5500, title: 'title_car_sedan',
    ...
    C({ id: 'big_block', vehicleType: 'muscle_car', band: 'ch6', price: 42000, title: 'title_car_muscle',
      dealer: 'Bert', note: '"Hood scoop, side pipes, the whole confession. Drinks gas like it\'s mad at gas. Glorious."' }),
    C({ id: 'the_nikolai', vehicleType: 'nikolai', band: 'ch6', price: 88000, title: 'title_car_nikolai',
    ...
    C({ id: 'drop_top', vehicleType: 'roadster', band: 'ch7', price: 95000, title: 'title_car_roadster',
      dealer: 'Bert', note: '"Convertible. Two seats, one of them for your sense of consequence, which you will leave at home."' }),
    C({ id: 'grand_tourer', vehicleType: 'grand_tourer', band: 'ch7', price: 130000, title: 'title_car_grand_tourer',
      dealer: 'Bert', note: '"A continent-eater. Chrome where it counts. The kind of smell you frame, not bottle."' }),
    C({ id: 'the_stretch', vehicleType: 'limo', band: 'ch8', price: 180000, title: 'title_car_limo',
