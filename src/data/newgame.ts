...
export const NEW_GAME_ENTRIES: NewGameEntry[] = [
  {
    ...
    kind: 'hero',
    sprite: 'rex',
    prompt: 'A quiet kid from Otterbrook. His name?',
  ...
  },
  {
    ...
    kind: 'hero',
    sprite: 'milo',
    prompt: 'Gadget genius. Tea snob. His name?',
  ...
  },
  {
    ...
    kind: 'hero',
    sprite: 'dorin',
    prompt: 'Of Stone Brow Monastery. His name?',
  ...
  },
  {
    ...
    kind: 'player',
    sprite: null,
    prompt: "And you, holding this? Don't be shy. Your name?",
    prefill: '',
    cap: NAME_CAP,
  ...
  },
  {
    ...
    kind: 'food',
    sprite: null,
    prompt: 'Your favorite homemade food?',
    prefill: 'corn dogs',
    cap: PHRASE_CAP,
    dontCare: [
      'corn dogs',
  ...
  },
  {
    ...
    kind: 'thing',
    sprite: null,
    prompt: 'And the coolest thing you can think of?',
    prefill: 'meteors',
    cap: PHRASE_CAP,
    dontCare: [
      'meteors',
