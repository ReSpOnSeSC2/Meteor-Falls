...
export const ABILITIES: Record<string, AbilityDef> = Object.fromEntries(
  [
    ...
    A({ id: 'hypno_a', name: 'Hypno a', kind: 'vibe', pp: 6, power: 0, target: 'enemy', element: 'none', status: 'asleep', text: '{user} hummed a lullaby!', fx: 'hypno' }),
    A({ id: 'shield_a', name: 'Shield a', kind: 'vibe', pp: 6, power: 0, target: 'ally', element: 'none', status: 'shield', text: '{user} raised a shimmer in the air!', fx: 'shield_snap' }),
    A({ id: 'shield_s', name: 'Shield S', kind: 'vibe', pp: 18, power: 0, target: 'allies', element: 'none', status: 'shield', text: '{user} raised a wall of shimmer!', fx: 'shield_snap' }),
    A({ id: 'flash_a', name: 'Flash a', kind: 'vibe', pp: 8, power: 0, target: 'enemies', element: 'none', status: 'crying', text: '{user} went off like a camera!', fx: 'flash' }),
    A({ id: 'teleport_a', name: 'Teleport a', kind: 'vibe', pp: 2, power: 0, target: 'self', element: 'none', text: '{user} started running!', fx: 'run_up' }),
    ...
    A({ id: 'vibe_freeze_o', name: 'Vibe Freeze O', kind: 'vibe', pp: 52, power: 286, target: 'enemy', element: 'freeze', text: 'Absolute zero, with feeling!', fx: 'freeze_o' }),
    A({ id: 'vibe_volt_a', name: 'Vibe Volt a', kind: 'vibe', pp: 9, power: 58, target: 'enemy', element: 'volt', text: '{user} pointed at the sky!', fx: 'volt_a' }),
    A({ id: 'vibe_volt_b', name: 'Vibe Volt B', kind: 'vibe', pp: 19, power: 128, target: 'enemies', element: 'volt', text: '{user} pointed at the sky!', fx: 'volt_b' }),
    A({ id: 'vibe_volt_g', name: 'Vibe Volt y', kind: 'vibe', pp: 36, power: 209, target: 'enemies', element: 'volt', text: 'The sky answered!', fx: 'volt_g' }),
    A({ id: 'magnet_a', name: 'Magnet a', kind: 'vibe', pp: 3, power: 0, target: 'enemy', element: 'none', status: 'pp_drain', text: '{user} held out her palm!', fx: 'magnet' }),
    ...
    // ---- Dorin
    A({ id: 'vibe_comet_a', name: 'Vibe Comet a', kind: 'vibe', pp: 20, power: 130, target: 'enemies', element: 'none', text: '{user} called down the cold stars!', fx: 'comet_a' }),
    A({ id: 'vibe_comet_o', name: 'Vibe Comet O', kind: 'vibe', pp: 60, power: 320, target: 'enemies', element: 'none', text: 'The sky opened. The stars remembered.', fx: 'comet_o' }),
    ...
    A({ id: 'healing_a', name: 'Healing a', kind: 'vibe', pp: 5, power: 0, target: 'ally', element: 'none', status: 'cure', text: '{user} pressed two fingers to the brow.', fx: 'healing_cure' }),
    A({ id: 'healing_g', name: 'Healing y', kind: 'vibe', pp: 20, power: 0, target: 'ally', element: 'none', status: 'revive', text: '{user} spoke an old word.', fx: 'healing_revive' }),
    A({ id: 'brainjam_a', name: 'Brainjam a', kind: 'vibe', pp: 12, power: 0, target: 'enemy', element: 'none', status: 'hushed', text: '{user} crossed the wires of a mind!', fx: 'brainjam' }),
    A({ id: 'brainjam_o', name: 'Brainjam O', kind: 'vibe', pp: 30, power: 0, target: 'enemies', element: 'none', status: 'hushed', text: '{user} crossed every wire at once!', fx: 'brainjam' }),
  ].map((a) => [a.id, a]),
);
