...
| rickshaw_swarm | monsoon_road, night_train | battle_rickshaw_swarm | mini:mini_rickshaw_swarm | authored | - |
| spice_djinn | monsoon_road, night_train, palace_throne | battle_spice_djinn | mini:mini_spice_djinn | authored | - |
| temple_macaque | monsoon_road, night_train, palace_throne | battle_temple_macaque | mini:mini_temple_macaque | authored | - |
| naga_sentry | monsoon_road, night_train, palace_throne | battle_naga_sentry | mini:mini_naga_sentry | authored | - |
| cobra_raja | - | battle_cobra_raja | mini:mini_cobra_raja | authored | - |
| paper_lantern_wisp | bamboo_road, spore_forest, mt_shu_temple | battle_paper_lantern_wisp | mini:mini_paper_lantern_wisp | authored | - |
| spore_puffer | bamboo_road, spore_forest, mt_shu_temple | battle_spore_puffer | mini:mini_spore_puffer | authored | - |
| origami_warrior | bamboo_road, spore_forest, mt_shu_temple | battle_origami_warrior | mini:mini_origami_warrior | authored | - |
| porcelain_warlord | spore_forest, mt_shu_temple | battle_porcelain_warlord | mini:mini_porcelain_warlord | authored | - |
