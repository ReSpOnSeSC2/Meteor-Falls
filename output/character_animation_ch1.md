...
- Path overrides: 0
- Characters with issues: 14
- Errors: 0
- Warnings: 0
- Review hints: 60

Interactive playback page: [character_animation_ch1.html](character_animation_ch1.html)
...
- REVIEW frame 5: walk left looks closer to downleft than left
- REVIEW frame 7: walk left looks closer to downleft than left
- REVIEW frame 9: walk right looks closer to downright than right
...
| npc_realtor | npc_realtor | npc | 8 |
| npc_waitress | npc_waitress | npc | 0 |
| nurse | nurse | npc | 0 |
